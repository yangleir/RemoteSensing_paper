...
gmt psbasemap -R1970/2022/0.5/800 -Bya1f2p -Bxa  -BWS+glightblue -JX4i/3il -K   >$ps
...
gmt psbasemap -R1970/2022/0.1/30000  -BE -Bya1f2p -Bxa -By+l'Global citation numbers' -J -K -O --MAP_LABEL_OFFSET=5p --MAP_FRAME_PEN=thinner,red --FONT_ANNOT_PRIMARY=10p,red --FONT_LABEL=10p,4,red >>$ps
awk 'NR>1 {print $1, $2}' ./cite/times.txt  | sort|gmt psxy -R -J -W2p,red -O -K >> $ps

gmt psbasemap -R1970/2022/.5/1000 -Bya1f2p -Bxa  -BWSe+glightblue -JX4i/3il -K  --MAP_GRID_PEN_PRIMARY=0.01p,0/0/0,2_1_0.25_1:0 -O -X5.5i>>$ps
